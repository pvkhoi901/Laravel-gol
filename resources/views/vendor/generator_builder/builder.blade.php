...
<div class="col-md-10 col-md-offset-1">
    <section class="content">
        ...
        <div class="box box-primary col-lg-12">
            ...
            <div class="box-header" style="margin-top: 10px">
                <h1 class="box-title" style="font-size: 30px">Admin Laravel Generator Builder</h1>
            </div>
            <div class="box-body">
                <form id="form">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="drdCommandType" class="form-control" style="width: 100%">
                            ...
                            <option value="infyom:scaffold" selected>Scaffold Generator</option>
                        </select>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <div class="form-inline form-group" style="border-color: transparent">
                            ...
                            <div class="checkbox chk-align">
                                <label>
                                    <input type="checkbox" class="flat-red" id="chkSave" checked>  <span
                                            class="chk-label-margin">Save Schema</span>
                                </label>
                            </div>
                            <div class="checkbox chk-align" id="chTest">
                                <label>
                                    <input type="checkbox" class="flat-red" id="chkTestCases" checked> <span
