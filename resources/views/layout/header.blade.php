                ...
                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                    ...
                    <div class="dropdown-body">
                        <a href="javascript:;" class="dropdown-item">
                            <div class="figure">
                                <img src="{{ asset('assets/images/user.jpg') }}" alt="userr">
                            </div>
                            <div class="content">
                ...
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    ...
                    <div class="dropdown-body">
                        <ul class="profile-nav p-0 pt-3">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('user.switch_theme', Auth::user()->theme === 'light' ? 'dark' : 'light') }}"
                                    class="nav-link">
                                    <i data-feather="repeat"></i>
                                    <span>{{ Auth::user()->theme === 'light' ? 'Dark theme' : 'Light theme'}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
